...
public class ShareSettingsOperation extends SocialOperation {
	...
	public ShareSettingsOperation(String serviceUrl, String authKey, String userId, boolean isUpdate, String key, Integer value) {
	...
	public Map<String, Object> parseResponse(String response) throws InvalidResponseDataException, InvalidRequestParametersException,
		...
		try {
			...
			ShareSettingsResponse shareSettingsResponse = gsonParser.fromJson(response, ShareSettingsResponse.class);
