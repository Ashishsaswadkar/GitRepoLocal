...
public class IabHelper {
     ...
     */
    public IabHelper(String fragmentTag, Context ctx, String base64PublicKey) {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        mServiceConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    ...
                    int response;
                    if (mFragmentTag.equalsIgnoreCase(DownloadFragment.TAG)) {
        ...
        if (!attempt) {
            ...
            if(listener != null){
            	 listener.onIabFailedBindToService(attempt);            	
            }
        }
    }
    ...
    public void launchPurchaseFlow(Activity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener, String extraData) {
        ...
        try {
            ...
            if (mFragmentTag.equalsIgnoreCase(DownloadFragment.TAG)) {
            	buyIntentBundle = mService.getBuyIntent(3, mContext.getPackageName(), sku, ITEM_TYPE_INAPP, extraData);
            } else {
            	buyIntentBundle = mService.getBuyIntent(3, mContext.getPackageName(), sku, ITEM_TYPE_SUBS, extraData);
            }
    ...
    int queryPurchases(Inventory inv) throws JSONException, RemoteException {
        ...
        do {
            ...
            Bundle ownedItems;
            if (mFragmentTag.equalsIgnoreCase(DownloadFragment.TAG)) {
            	ownedItems = mService.getPurchases(3, mContext.getPackageName(),
