...
public class ImageCache {
    ...
    public Bitmap getBitmapFromMemCache(String data) {
        if (mMemoryCache != null) {
        	//Log.i(TAG, "Start getBitmapFromMemCache "+data);
            final Bitmap memBitmap = mMemoryCache.get(data);
            //Log.i(TAG, "Finish getBitmapFromMemCache "+data);
            if (memBitmap != null) {
                if (BuildConfig.DEBUG) {
    	...
    	if ( context != null ) {
	        cachePath =
	                Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) ||
	                        !isExternalStorageRemovable() ? (getExternalCacheDir(context) != null ? getExternalCacheDir(context).getPath() : "") :
    ...
    public static class RetainFragment extends Fragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // TODO: WTF?? no configuration changes in the application.
